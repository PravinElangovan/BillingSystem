...
ResultSet Rs = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       {
        String Query = "Select * from Seller where SELNAME='"+Uid.getText()+"'and SELLPASS='"+password.getText()+"'";
       try{
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/SuperMarketdb","root","1234");
       ...
       {
             String Query = "Select * from admin where ADMINNAME='"+Uid.getText()+"'and ADMINPASS='"+password.getText()+"'";
       try{
